...
class InstaData{
	...
	public function getAccountFollowers($username){
		...
		return $accountData['followers'];
	}

	public function getAccountFollowing($username){
...
$k=new InstaData();
$re=$k->getAccountDetails("ram_krishna92");
echo "$re";
?>